    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="addAnnounce.php">
                        <i class="fa fa-bullhorn"></i> <span>发布通知</span>
                    </a>
                </li>
                <li>
                    <a href="addPayCode.php">
                        <i class="fa fa-plus"></i> <span>添加充值卡</span>
                    </a>
                </li>
                <li>
                    <a href="sys.php">
                        <i class="fa fa-list"></i> <span>系统信息</span>
                    </a>
                </li>
            </ul>
        </section>
